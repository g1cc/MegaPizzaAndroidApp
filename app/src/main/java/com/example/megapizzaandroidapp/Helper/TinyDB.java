...
public class TinyDB {
    ...
    public ArrayList<PizzaDomain> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<PizzaDomain> playerList =  new ArrayList<PizzaDomain>();

        for(String jObjString : objStrings){
            PizzaDomain player  = gson.fromJson(jObjString,  PizzaDomain.class);
    ...
    public void putListObject(String key, ArrayList<PizzaDomain> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(PizzaDomain player: playerList){
